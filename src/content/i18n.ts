...
export function dict(lang: Lang) {
  ...
  return {
    ...
    marches: {
      ...
      bidderKicker: t("Espace soumissionnaire", "Bidder space"),
      bidderTitle: t("Devenez soumissionnaire", "Become a bidder"),
      bidderLead: t(
        "Pour soumissionner, contactez la cellule passation : accès aux dossiers (DAO/RFP), calendrier et modalités de dépôt, en lien avec STEP.",
        "To bid, contact the procurement unit: access to the documents (DAO/RFP), schedule and submission terms, linked to STEP.",
      ),
