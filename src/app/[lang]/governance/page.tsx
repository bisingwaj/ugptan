      ...
      <section className="section">
        <div className="section__inner">
          ...
          <RevealGroup className="grid-3 celled--top" gap={0.05}>
            {gouvernance.map((b) => (
              <RevealItem key={b.sigle} className="cell organe-cell">
        ...
        <div className="section__inner">
          ...
          <RevealGroup className="cols2" gap={0.05} style={{ gap: 1, background: "var(--c-20)", border: "1px solid var(--c-20)" }}>
            {[
              ...
              <RevealItem key={col.sigle} style={{ background: "#fff", padding: "34px clamp(20px,3vw,38px)" }}>
        ...
        <div className="section__inner">
          ...
          <RevealGroup gap={0.045} style={{ display: "flex", flexDirection: "column", gap: 1, background: "var(--c-80)", border: "1px solid var(--c-80)" }}>
            {gouvActivites.map((a, i) => (
              <RevealItem key={i} className="gov-act" style={{ background: "var(--c-black)", padding: "24px clamp(20px,2.4vw,30px)", display: "grid", gridTemplateColumns: "150px 1fr", gap: "clamp(14px,2vw,32px)", alignItems: "start", borderLeft: `3px solid ${a.color}` }}>
                <div>
